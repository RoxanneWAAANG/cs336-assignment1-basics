...
from cs336_basics.training_loop.data_loading import get_batch
...
def run_embedding(
    ...
    # load weights into the embedding layer.
...
def run_scaled_dot_product_attention(
    ...
    # raise NotImplementedError
    d_k = Q.shape[-1]
    attention = Attention(d_k=d_k)
    return attention(M=mask, Q=Q, K=K, V=V)
